namespace Dashboard_STAFF
{
    partial class PurchaseOrders_ADMIN
    {
        ...
        private void InitializeComponent()
        {
            ...
            purchaseOrders_dataGridView.Columns.AddRange(new DataGridViewColumn[] { PurchaseID, item, Brand, Quantity, TotalPrice, SupplierName, StaffName, OrderStatus });
