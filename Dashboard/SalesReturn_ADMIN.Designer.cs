namespace Dashboard_STAFF
{
    partial class SalesReturn_ADMIN
    {
        ...
        private void InitializeComponent()
        {
            ...
            salesReturns_dataGridView.Columns.AddRange(new DataGridViewColumn[] { ReturnID, item, Brand, Quantity, TotalPrice, ReturnDate, Reason, StaffName });
            ...
            salesReturns_dataGridView.Size = new Size(1231, 835);
